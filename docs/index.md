...
[Download the latest release (version 3.0.1)](https://raw.githubusercontent.com/peter88213/yw-timeline/main/dist/yw-timeline_v3.0.1.zip)

- Unzip the downloaded zipfile "yw-timeline_v3.0.1.zip" into a new folder.

...
- [Timeline 2.4](http://thetimelineproj.sourceforge.net/).


## Download and install

[Download the latest release (version 0.1.6)](https://raw.githubusercontent.com/peter88213/yw-timeline/main/dist/yw-timeline_v0.1.6.zip)

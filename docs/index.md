...
[Download the latest release (version 2.0.2)](https://raw.githubusercontent.com/peter88213/yw-timeline/main/dist/yw-timeline_v2.0.2.zip)

- Unzip the downloaded zipfile "yw-timeline_v2.0.2.zip" into a new folder.

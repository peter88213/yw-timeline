...
[Download the latest release (version 0.1.7)](https://raw.githubusercontent.com/peter88213/yw-timeline/main/dist/yw-timeline_v0.1.7.zip)

- Unzip the downloaded zipfile "yw-timeline_v0.1.7.zip" into a new folder.

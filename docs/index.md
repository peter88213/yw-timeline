...
[Download the latest release (version 1.2.1)](https://raw.githubusercontent.com/peter88213/yw-timeline/main/dist/yw-timeline_v1.2.1.zip)

- Unzip the downloaded zipfile "yw-timeline_v1.2.1.zip" into a new folder.

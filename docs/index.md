...
[Download the latest release (version 0.7.0)](https://raw.githubusercontent.com/peter88213/yw-timeline/main/dist/yw-timeline_v0.7.0.zip)

- Unzip the downloaded zipfile "yw-timeline_v0.7.0.zip" into a new folder.

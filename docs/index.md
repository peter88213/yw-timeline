...
[Download the latest release (version 1.2.2)](https://raw.githubusercontent.com/peter88213/yw-timeline/main/dist/yw-timeline_v1.2.2.zip)

- Unzip the downloaded zipfile "yw-timeline_v1.2.2.zip" into a new folder.

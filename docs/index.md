...
[Download the latest release (version 0.3.1)](https://raw.githubusercontent.com/peter88213/yw-timeline/main/dist/yw-timeline_v0.3.1.zip)

- Unzip the downloaded zipfile "yw-timeline_v0.3.1.zip" into a new folder.
